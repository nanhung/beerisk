...
Data2
mod2 <- nls(y ~ 0.25*x^b/(a^b+x^b), data = Data2, start=list(a=3000,b=1))
...
p2 <- ggplot(Data2, aes(x, y)) + geom_point() + stat_smooth(method = "nls", formula = y ~ 0.24169*x^b/(a^b+x^b), data = Data2, method.args=list(start= c(a=3000,b=1)), se=FALSE)+
